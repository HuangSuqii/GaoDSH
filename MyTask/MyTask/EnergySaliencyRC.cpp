...
Mat EnergySaliencyRC::GetBorderReg(CMat &idx1i, int regNum, double ratio, double thr)
{
	// Variance of x and y
...
void EnergySaliencyRC::SmoothByHist(CMat &img3f, Mat &sal1f, float delta)
{
...
void EnergySaliencyRC::SmoothByRegion(Mat &sal1f, CMat &segIdx1i, int regNum, bool bNormalize)
{
...
Mat EnergySaliencyRC::GetRC(CMat &img3f, CMat &regIdx1i, int regNum, double sigmaDist)
{
...
Mat EnergySaliencyRC::GetRC(CMat &img3f, double sigmaDist, double segK, int segMinSize, double segSigma)
{
